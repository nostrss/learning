...
- 커리큘럼: ① 핸드셰이크(완료, 이해 확인됨) → ② 프레임 구조(완료, 질문 다수로 보강됨) → ③ 종료 핸드셰이크와 close code(완료, 질문 4건으로 보강됨) → ④ ping/pong과 keepalive(레슨 작성됨) → ⑤ HTTP/2·3 위의 WebSocket(RFC 8441/9220) → ⑥ 확장(permessage-deflate)
